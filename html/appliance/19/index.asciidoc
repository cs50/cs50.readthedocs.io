...
* If you have a *Mac*, we recommend that you follow  link:VMWare/Fusion[these instructions for VMVare Fusion].
* If you have a *PC running Windows*, we recommend that you follow link:VMWare/Workstation[these instructions for VMWare Workstation].
* If you have a *PC running Linux*, we recommend that you follow link:VMWare/Workstation[these instructions for VMWare Workstation].
