...
. Download the CS50 Appliance itself from http://mirror.cs50.net/appliance50/2015/releases/29/appliance50-2015-vmware.ova (http://mirror.cs50.net/appliance50/2015/releases/29/appliance50-2015-vmware.ova.torrent[torrent]). That file is nearly 2GB in size, so it might take a while to download.
. Launch VMware Workstation 11 and select *Open...* from the *File* menu, then navigate to *appliance50-2015-vmware.ova* (which is likely in your *Downloads* folder) and select it. Click *Open*.
...
. Download the CS50 Appliance from http://mirror.cs50.net/appliance50/2015/releases/29/appliance50-2015-vmware.ova (http://mirror.cs50.net/appliance50/2015/releases/29/appliance50-2015-vmware.ova.torrent[torrent]).
