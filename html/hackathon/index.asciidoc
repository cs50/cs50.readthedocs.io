...
Some, yes. It'll be set aside, so just check with Daven as to where it is. If you have trouble finding Daven, call 617-BUG-CS50, option H, to reach another of the course's heads!
