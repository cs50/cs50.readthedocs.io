...
* http://wiki.cs50.net/index.php?title=HarvardFood_API&oldid=1014[1.0]
* http://wiki.cs50.net/index.php?title=HarvardFood_API&oldid=1645[1.1]
** Added support for JSONP.
* http://wiki.cs50.net/index.php?title=HarvardFood_API&oldid=3376[1.2]
