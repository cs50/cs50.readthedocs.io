...
. Sign in to http://calendar.google.com/[Google Calendar].
. Select *Calendar settings* under the *Settings* menu in the page's
top-right corner.
. Click the *Calendars* tab below *Calendar Settings* in the page's
top-left corner.
. Click the name of the calendar that you want to add to
HarvardEvents.
. Click the *Share this calendar* tab to the right of the *Calendar
Details* tab.
. Check the box next to *Make this calendar public*, if not checked
already. Do not check the box next to *Share only my free/busy
information*.
. Click *Save*.
. Again select *Calendar settings* under the *Settings* menu in the
page's top-right corner.
. Again click the *Calendars* tab below *Calendar Settings* in the
page's top-left corner.
. Again click the name of the calendar that you want to add to
HarvardEvents.
. Don't click *Share this calendar this time*. Instead, scroll down to
*Calendar Address*.
. Click the green *ICAL* icon.
. Highlight and copy the address that appears. This is the URL of your
...
. Sign into http://calendar.google.com/[Google Calendar]. You'll need
to
http://www.google.com/support/calendar/bin/answer.py?hl=en&answer=37005[create
an account] if you don't already have one.
. Once signed in, click *Create event* toward Google Calendar's
top-left corner and
...
a repeating event].
. Into the text box under *Add guests*, paste the email address below.
...
. Sign in to http://docs.google.com/[Google Docs] and open your
spreadsheet.
. Click *Share* in the page's top-right corner.
. Select *Publish as a web page* in the menu that appears.
. Check the box next to *Automatically republish when changes are
made*, if not checked already, in the window that appears.
. Click *Start publishing*.
. Select *CSV (comma-separated values)* and *Sheet1* in the menus
below *Get a link to the published data*; leave *All cells* as-is.
. Highlight and copy the URL that appears in the text area.
. Submit the form below.
