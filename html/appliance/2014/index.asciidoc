...
In case your computer is unable to support a virtual machine, or you simply prefer not to use one, and you know how to install Linux from an ISO-9660 image, we provide link:http://mirror.cs50.net/appliance50/2014/releases/29/appliance50-2014.iso[an ISO image] that you can use to install an Ubuntu system equivalent to the CS50 Appliance on "bare metal".
