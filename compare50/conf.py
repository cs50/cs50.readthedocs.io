...
# -*- coding: utf-8 -*-
#
# compare50 documentation build configuration file, created by
...
htmlhelp_basename = 'compare50doc'
...
latex_documents = [
    (master_doc, 'compare50.tex', 'compare50 Documentation',
     'CS50', 'manual'),
]
...
man_pages = [
    (master_doc, 'compare50', 'compare50 Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'compare50', 'compare50 Documentation',
     author, 'compare50', 'One line description of project.',
     'Miscellaneous'),
]
