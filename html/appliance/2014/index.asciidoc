...
* *If taking CS50 (or CSCI E-50) in Fall 2014, you should use this version of the appliance.*
* *If taking CS50x, you should use link:../19[version 19] of the appliance.*
...
* *If following http://cs50.tv/2009/fall/[Fall 2009] of CS50, you should use link:../1.4[version 1.4] instead.*
...
* If you have a *PC running Windows*, we recommend that you follow link:player/[these instructions for VMware Player].
* If you have a *PC running Linux*, we recommend that you follow link:player/[these instructions for VMware Player].
