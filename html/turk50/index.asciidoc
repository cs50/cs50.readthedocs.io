...
1. http://docs.amazonwebservices.com/AWSMechTurk/latest/AWSMechanicalTurkGettingStartedGuide/[Getting
Started Guide]
2. http://docs.amazonwebservices.com/AWSMechanicalTurkRequester/2008-08-02/[Developer
Guide]
...
with link:#_getaccountbalance[GetAccountBalance], `Operation` is
