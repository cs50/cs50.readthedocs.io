...
To chat with classmates during the Hackathon, visit https://cs50.harvard.edu/chat[cs50.harvard.edu/chat]. If informed that "account has already been created using that email address," visit https://hackathon50.hipchat.com[hackathon50.hipchat.com] instead. Click *Launch the web app* if prompted.
