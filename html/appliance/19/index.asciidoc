...
* If you have a *PC running Windows*, we recommend that you follow link:VMWare/VMware_Player/[these instructions for VMWare Player].
* If you have a *PC running Linux*, we recommend that you follow link:VMWare/VMware_Player/[these instructions for VMWare Player].
