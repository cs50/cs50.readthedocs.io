...
. Download the CS50 Appliance itself at http://mirror.cs50.net/appliance50/2014/releases/26/appliance50-2014-vmware.ova (http://mirror.cs50.net/appliance50/2014/releases/26/appliance50-2014-vmware.ova.torrent[torrent]).  That file is nearly 2GB in size, so it might take a while to download.
