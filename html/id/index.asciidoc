...
`id50/sample/templates/sample/index.html`
...
def login(request):
    if 'user' in request.session:
        ...
        return HttpResponseRedirect(CS50.getLoginUrl('tmp', 'http://127.0.0.1:8000', 
            'http://127.0.0.1:8000/sample/return_to/', request.session))
...
-----
...
def return_to(request):
    user = CS50.getUser('tmp', 'http://127.0.0.1:8000/sample/return_to/', request, 'sample:return_to')
