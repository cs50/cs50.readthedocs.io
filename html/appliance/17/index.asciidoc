...
* * Once you link:#__how_to_enable_mysql[enable MySQL]. +

* ** Once you link:#__how_to_enable_apache[enable Apache] and
link:#__how_to_enable_mysql[enable MySQL].
...
link:#_how_to_open_a_terminal[opening a terminal] and executing:
...
link:#_how_to_install_appliance[instructions] above. Thereafter, you'll
...
link:#_how_to_synchronize_files_with_dropbox[synchronizing with Dropbox]
...
1.  Start (or link:#_how_to_restart_appliance[restart]) the appliance.
...
back to *crimson* by link:#_how_to_open_a_terminal[opening a terminal]
