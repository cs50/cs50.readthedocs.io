...
[options="compact"]
*This documentation is for version 2014 of the CS50 Appliance.*

* *You should use this version of the appliance if you are:*
** *taking CS50x 2015 through edX,*
** *taking CSCI E-50 in Spring 2015 through Harvard Extension School, or*
** *pursuing a CS50 Certificate in 2015 through Harvard Division of Continuing Education.*
...
|*Appliance's Version* | a number of the form *2014-nn*, (where *nn* is a minor version number) which can be found in the appliance's bottom-right corner
...
* If you have a *PC running Windows or Linux*, we recommend that you follow link:workstation/[these instructions for VMware Workstation].

Alternatively (and particularly if you run into trouble with VMware Fusion or VMware Workstation), you can follow link:virtualbox/[these instructions for VirtualBox].
...
you should see *2014-nn* in boldface, where *nn* is a number. Alternatively, you can
...
which should report `2014-nn` as well.
